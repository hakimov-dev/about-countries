<template>
  <div class="container-xl px-[5%] !pt-[20vh]">
    <div class="filter w-full flex items-center justify-between">
      ...
      <select class="select select-bordered dark:bg-[#18181B] bg-white dark:text-white outline-none text-black w-[20%] max-w-xs" @change="$store.dispatch('searchRegion', $event)">
